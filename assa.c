...
int createQuestionMarkPerson(int* question_mark_person_counter, struct _Person_** person)
{
...
int parsePersonsFromInputFileLine(char* input_string, struct _PersonList_* people_list, int num_people)
{
  int index = 0;
  int entries_made = 0;
