...
//
//  @return -> difference between two elements that is used by qsort
//
...
//  draw or draw-all
//
//  @param first_string_pointer -> pointer to first comparison argument
//  @param second_string_pointer -> pointer to second comparison argument
//
//  @return -> difference between two elements used by qsort to sort elements
//
...
//
//  @param line_buffer -> buffer to which the line should be added
...
//  written
//  @param character -> character that should be written to the buffer
//
...
//  @param question_mark_gender -> gender that the new question_mark_person
//  should have
//
//  @return MEMORY_EXCEPTION on failure to allocate memory or NORMAL on
//  success
...
//
//  @param link_to_replace -> the link whose occurrences should be replaced
//  for all persons in the person list
//  @param replacement -> the link, link_to_replace should be replaced with
//  @param person_list -> the person list in which the links should be
//  replaced 
//
...
//  a person list (avoids circles and question marks are replaced).
//
//  @param person1 -> first person in relationship (e.g the father, or mother,
//  or grandfather relative to second person)
//  @param person2 -> second person in relationship
//  @param all_persons -> the list of persons in which the specified 
//  relationship should be created between the persons.
//  @param question_mark_person_counter -> variable that is used to number
//  new question mark persons, that may have to be created during the function.
//  @param relation -> The relation that should be used for the persons.
//
...
//
//  @return -> ERROR if error (input format)  is encountered while parsing 
//  console input from the user. NORMAL otherwise.
//
...
//  @param all_persons -> struct that should hold the list of all persons
//  @param question_mark_person_counter -> used to store the current question
//  mark id. (question_mark_person_counter is set to the highest id present
//  in the input file, so that new question mark persons can be created with
//  valid ids)
//  
//
